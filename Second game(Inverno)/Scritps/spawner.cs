...
public class spawner : MonoBehaviour
{
    ...
    //[SerializeField] List<GameObject> snow = new List<GameObject>();
    ...
    void Start()
    {
        gameManager.instance.enemiesToKill += spawnCount;
    }
    ...
    void Update()
    {
        ...
        else if(enemiesSpawned == spawnCount)
        {
            Destroy(gameObject);
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if(other.CompareTag("Player"))
        {
            ...
            gameManager.instance.changeSpawnPos(gameObject);
        }
    }
}
